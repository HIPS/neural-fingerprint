...
\end{column}
\begin{column}{5cm}
\hspace{-1cm}\includegraphics<1>[width=6cm]{../../DeepMoleculesData/experiments/2015-05-04-compare-fingerprints/91-try-again/morg_conv_corr.pdf}
...
\item Play with depth of neural net on top (used one hidden layer here)
\end{itemize}
}
