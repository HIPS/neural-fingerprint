...
def build_vanilla_net(num_inputs, h1_size, h1_dropout):
    ...
    # Need to give fake data here so that the dropout node can make a mask.  TODO: refactor dropout.
    ...
    dropout = ky.Dropout(hidden, drop_prob = h1_dropout)
    ...
    # All the functions we'll need to train and predict using this net.
    def grad_fun(w, i, t):
