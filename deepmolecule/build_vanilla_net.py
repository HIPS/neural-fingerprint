...
def build_vanilla_net_ag(num_inputs, h1_size):
    """Just a plain old 2-layer net, nothing to do with molecules."""
...
def build_morgan_deep_net_ag(fp_length=512, fp_radius=4, h1_size=500):
    """A 2-layer net whose inputs are Morgan fingerprints."""
    v_loss_fun, v_grad_fun, v_pred_fun, v_hiddens_fun, parser = \
        build_vanilla_net_ag(num_inputs=fp_length, h1_size=h1_size)
