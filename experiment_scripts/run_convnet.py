...
from deepmolecule import tictoc, load_data, build_universal_net, train_nn
...
def run_conv_net(params_file, output_dir):
    ...
    conv_train_params = allparams['conv_train_params']
    conv_arch_params = allparams['conv_arch_params']
