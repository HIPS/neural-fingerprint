...
\cite{bruna2013spectral} Spectral networks on graphs
...
Drug efficacy (EC$_{50}$ in nM) & \citet{gamo2010thousands}   &   RMSE & ?               &      ?               \\
...
Computing the neural fingerprint of depth $R$, width $W$ of a molecule with $N$ atoms, Neural fingerprints have the same asymptotic complexity
