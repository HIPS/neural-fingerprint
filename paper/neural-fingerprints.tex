...
\begin{figure}
\centerline{\includegraphics[width=0.4\textwidth, clip, trim=4mm 12mm 4mm 4mm]{../../DeepMoleculesData/experiments/2015-06-01-fig1/1/fingerprint_computation_schematic.pdf}
\hspace{2em}
...
To begin with a graph is constructed matching the topology
\emph{Right}: A more detailed}
