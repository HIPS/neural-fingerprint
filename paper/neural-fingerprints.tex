...
This function is differentiable, and allows the computed result to be similar even when the local molecular structure varies in small ways.
...
\begin{figure}[h]
\centerline{\includegraphics[width=0.48\textwidth]{../../DeepMoleculesData/experiments/2015-05-04-compare-fingerprints/92-distance/morg_conv_corr.pdf}
