...
%\citet{unterthiner2015toxicity}, \citet{ma_qsar_2015}
...
Every non-differentiable operation has been replaced with a differentiable analog.}
\end{figure*}
...
%
\newcommand{\molfeature}[2]{\includegraphics[width=3.4cm]{../../DeepMoleculesData/experiments/2015-05-30-visualize-fps/1/figures/fp_#1_highlight_#2.pdf}}%
\begin{figure}[h]%
...
We ran a similar experiment on data from the \citet{tox21}.
...
Each simulation requires tens of CPU hours, meaning that accurately predicting outcome of the simulation can greatly speed up the virtual screening process.
\end{itemize}
%
