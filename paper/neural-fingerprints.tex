...
To optimize hyperparameters, we used {\sc Whetlab} (\url{www.whetlab.com}), a commercial implementation of Bayesian optimization~\citep{snoek2012practical}.
...
Since we required relatively complex control flow and indexing in order to implement variants of Algorithm \ref{alg:neural}, we used a more flexible automatic differentiation package for Python, {\sc Autograd} (\url{github.com/HIPS/autograd)}.
