...
We compare the effectiveness of neural graph fingerprints against standard fingerprints at predicting %toxicity,
...
\newcommand{\molfeature}[3]{\includegraphics[width=#3, clip, trim = 2mm 3mm 2mm 6mm]{../../DeepMoleculesData/experiments/2015-05-30-visualize-fps/1/figures/fp_#1_highlight_#2.pdf}\vspace{-1em}}%
\begin{figure}[h]%
\vspace{-1em}
...
We ran our methods on a subset of 10,000 of these molecules.
...
First, with a linear layer on top of the predictions, and second, with a one-hidden-layer neural network.
Results are summarized in Table~\ref{table:main results}.
%
\begin{table}
\begin{center}
\begin{tabular}{r|lll}
%Predicted property                                        & Predict Mean       &   Circular fingerprints  & Circular fingerprints & Neural fingerprints & Neural fingerprints \\
%                                                          &                    &  with lin. reg.          &  with neural net      &  with lin. reg.     &  with neural net    \\
%\midrule
%Solubility (log Mol/L)          \citet{delaney_data_2004} & 4.29 $\pm$ 0.40    & 1.84 $\pm$ 0.08          & 1.40 $\pm$ 0.15       & 0.74 $\pm$ 0.09     & 0.53 $\pm$ 0.07 \\
%Drug efficacy (EC$_{50}$ in nM) \citet{gamo2010thousands} & 1.47 $\pm$ 0.07    & 1.13 $\pm$ 0.03          & 1.24 $\pm$ 0.03       & 1.16 $\pm$ 0.03     & 1.17 $\pm$ 0.03 \\
%Photovoltaic efficiency (\%)  \citet{hachmann2011harvard} & 6.40 $\pm$ 0.09    & 2.62 $\pm$ 0.07          & 2.04 $\pm$ 0.07       & 2.71 $\pm$ 0.13     & 1.44 $\pm$ 0.11
...
We thank Edward Pyzer-Knapp and Samsung Advanced Institute of Technology for their support.
