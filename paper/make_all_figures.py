...
def main():
    ...
    atom2vec_weights_file = os.path.join(atom2vec_experiment_dir, 'convnet-predictions-mass.npz')

    plot_predictions(atom2vec_weights_file, os.path.join(figures_dir, 'convnet-predict-mass-plots'))
